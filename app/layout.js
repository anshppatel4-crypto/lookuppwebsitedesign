  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body suppressHydrationWarning>
        <Providers>
          <Navbar />
          <div className="flex w-full flex-col items-center space-y-4 rounded-b-[140px] bg-gradient-to-b from-[#ffffff] to-[#f3f6ff] pb-10 pt-8 text-center sm:pt-10">
            ...
            <a
              ...
              className="rounded-full bg-[#3055CF] px-10 py-3.5 text-lg font-medium text-white shadow-md transition-all duration-200 hover:bg-[#2748b3] sm:text-xl"
            >
