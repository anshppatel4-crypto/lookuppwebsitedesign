    ...
    return (
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4 lg:justify-start">
                              <a
                href="#download"
                className="rounded-full bg-gradient-to-r from-[#116DFF] to-[#3055CF] px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-[#3055CF]/30 transition-all duration-300 hover:shadow-xl hover:shadow-[#3055CF]/40"
              >
                                  Download Today
              </a>
              <a
