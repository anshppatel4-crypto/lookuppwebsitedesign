    ...
    <section className="relative overflow-hidden bg-[#f6f7fb] py-24">
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-[#16163F]/60">Three simple steps to more presence and real rewards.</p>
        </Reveal>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {STEPS.map((s, i) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="group relative overflow-hidden rounded-3xl border border-white bg-white p-8 shadow-[0_20px_60px_-30px_rgba(48,85,207,0.35)]"
            >
