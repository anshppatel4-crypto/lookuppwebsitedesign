...
export default function PhoneMockup({ className = '', image, alt = 'Lookupp app screenshot', tone = 'blue', delay = 0, float = 'animate-floaty', label = false }) {
  ...
  return (
    ...
    >
      <div className="relative h-[396px] w-[178px] rounded-[2.5rem] bg-[#0f0f2e] p-[6px] shadow-[0_40px_80px_-30px_rgba(22,22,63,0.6)] ring-1 ring-white/10 lg:h-[535px] lg:w-[240px]">
