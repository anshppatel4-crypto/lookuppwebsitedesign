import { Users, HeartHandshake, Gift, Timer, Utensils, GraduationCap, Ticket } from 'lucide-react'

export const SITE = {
  logo: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-mazosL1A4xM8jbhPDFNBTKhIc19C8F.png',
...
export const SUPPORTERS = [
  { name: 'Blue Ocean Competition', href: 'https://blueoceancompetition.org/2022-2023-winners/', src: 'https://static.wixstatic.com/media/016a1b_6a9148561e0549aea31e13cdcdb57064~mv2.png/v1/fill/w_126,h_122,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/blue%20ocean_edited.png' },
  { name: 'Congressional App Challenge', href: 'https://www.congressionalappchallenge.us/22-NC07/', src: 'https://static.wixstatic.com/media/016a1b_cd84a7b6591b409ab0329a3eab419b7a~mv2.png/v1/fill/w_215,h_122,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/016a1b_cd84a7b6591b409ab0329a3eab419b7a~mv2.png' },
  { name: 'Young Futures', href: 'https://youngfutures.org/grantees/lookupp', src: 'https://static.wixstatic.com/media/016a1b_8fdb2cf350a5459189bfaf470a021594~mv2.png/v1/fill/w_133,h_129,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/016a1b_8fdb2cf350a5459189bfaf470a021594~mv2.png' },
  { name: 'Taco Bell Ambition Accelerator', href: 'https://www.tacobell.com/news/taco-bell-foundation-introduces-the-next-generation-of-young-changemakers-making-global-social-change', src: 'https://static.wixstatic.com/media/016a1b_5c7ee8b03b7648c4a4737ca7510fe4c5~mv2.png/v1/fill/w_197,h_122,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/016a1b_5c7ee8b03b7648c4a4737ca7510fe4c5~mv2.png' },
  { name: 'YEPex', href: 'https://uncw.edu/seahawk-life/get-involved/community/teens-children/innovation-entrepreneurship-competition/?utm_source=hscompetition&utm_medium=301&utm_id=REDIR1', src: 'https://static.wixstatic.com/media/016a1b_522098ab695846759b53d4ee7adf4b2b~mv2.jpeg/v1/fill/w_248,h_96,al_c,q_80,usm_0.66_1.00_0.01,enc_avif,quality_auto/016a1b_522098ab695846759b53d4ee7adf4b2b~mv2.jpeg' },
]
...
export const SCREENSHOTS = {
  welcome: 'https://customer-assets-4nw71qhi.emergentagent.net/job_people-first-web/artifacts/ku7sx4px_welcome%20screenshot%20%281%29.webp',
  zone: 'https://customer-assets.emergentagent.com/job_people-first-web/artifacts/jypwrjv7_blue%20screenshot.webp',
  start: 'https://customer-assets-4nw71qhi.emergentagent.net/job_people-first-web/artifacts/nr4nh786_IMG_3078.webp',
  rewards: 'https://customer-assets-4nw71qhi.emergentagent.net/job_people-first-web/artifacts/m2kfgk9p_IMG_3080.webp',
}
