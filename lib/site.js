import { PhoneOff, HeartHandshake, Gift, Utensils, GraduationCap, Ticket } from 'lucide-react'
...
export const STEPS = [
  {
    ...
    desc: 'Start a Lookupp zone the moment you sit down together. Your phone goes down, your attention goes up.',
  },
  {
    icon: HeartHandshake,
    title: 'Spend quality time',
    desc: 'Be fully present with friends and family. Real conversations, real laughs, real memories.',
  },
  {
    icon: Gift,
    title: 'Earn rewards',
    desc: 'Get rewarded for every screen-free moment you share. Presence pays off, literally.',
  },
]
...
export const TEAM = [
  {
    name: 'Atiksh Bhan',
    role: 'CEO',
    photo: 'https://api.dicebear.com/7.x/notionists/svg?seed=AtikshBhan&backgroundColor=b6e3f4,c0aede&radius=20',
  },
  {
    name: 'Samin Bhan',
    role: 'Special Adviser',
    photo: 'https://api.dicebear.com/7.x/notionists/svg?seed=SaminBhan&backgroundColor=d1d4f9,ffd5dc&radius=20',
  },
]
